...
export default function LandingHome(){
  ...
  return <main className="paper-landing">
    ...
    <header className="paper-nav">
      ...
      <nav className="paper-nav-links"><Link href="/discover">Discover</Link><Link href="/spot">Spot</Link><Link href="/pulse">Pulse</Link><Link href="/evaluation">Evaluation</Link><Link href="/portfolio">Portfolio</Link><Link href="/charity">Charity</Link><Link href="/profile">Profile</Link></nav>
