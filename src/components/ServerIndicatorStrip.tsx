...
type Data={
  ...
  indicators?:{ema9?:number;ema21?:number;vwap?:number;rsi14?:number|null;macd?:{line?:number;signal?:number;histogram?:number};bollinger20?:{upper?:number;middle?:number;lower?:number}}
}
...
export default function ServerIndicatorStrip({pool,timeframe}:{pool?:string;timeframe:string}){
  ...
  const i=data.indicators||{},rsi=Number(i.rsi14||0),hist=Number(i.macd?.histogram||0)
