...
export default function Terminal(){
  ...
  async function executeTrade(target=selected,action=side){
    ...
    if(confirmOrders&&!instantMode&&!window.confirm('Confirm PAPER '+action.toUpperCase()+' for setMessage('');setReceipt(null)
    try{
...
+target.symbol+'? This is simulated only.'))return
