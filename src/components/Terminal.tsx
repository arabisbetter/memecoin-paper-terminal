...
export default function Terminal(){
  ...
  async function persistPresets(){
    ...
    catch(error){console.error('paper_preset_save_error',error);setMessage(error instanceof Error?error.message:'Could not save quick-buy presets.')}
