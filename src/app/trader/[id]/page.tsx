...
export default function TraderPage(){
  ...
  const [cards,setCards]=useState<Card[]>([]),[activity,setActivity]=useState<Activity[]>([])
  ...
  const load=useCallback(async()=>{
    ...
    try{
      ...
      setProfile(p as Profile);setStats((s as Stats|null)||null);setCards((c||[]) as Card[]);setActivity((a||[]) as Activity[])
